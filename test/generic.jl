...
@timedtestset "Names of SU4Irrep:" begin
    dimnames = ["1", "4⁺", "6", "4", "10", "20", "20′", "15", "20⁺", "10⁺", "20″", "45",
...
@timedtestset "Names of SU5Irrep:" begin
    dimnames = ["1", "5⁺", "10⁺", "10", "5", "15⁺", "40", "50", "45", "75", "50⁺", "24",
...
@timedtestset "LaTeX names of SU3Irrep" begin
    latexnames = [L"$\textbf{1}$", L"$\overline{\textbf{3}}$", L"$\textbf{3}$",
...
@timedtestset "LaTeX names of SU4Irrep" begin
    latexnames = [L"$\textbf{1}$", L"$\overline{\textbf{4}}$", L"$\textbf{6}$",
...
@timedtestset "LaTeX names of SU5Irrep" begin
    latexnames = [L"$\textbf{1}$", L"$\overline{\textbf{5}}$",
